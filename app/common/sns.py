...
class GoogleLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        data = {
            ...
            'redirect_uri': 'http://localhost:8888/youtube/api/callback/google' if JsonConfig.get_data('APP_MODE') == Config.APP_MODE_DEVELOPMENT else 'http://localhost:8888/youtube/api/callback/google',
...
class KakaoLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        data = {
            ...
            'redirect_uri': 'http://localhost:8888/youtube/api/callback/kakao' if JsonConfig.get_data('APP_MODE') == Config.APP_MODE_DEVELOPMENT else 'http://localhost:8888/youtube/api/callback/kakao',
            'code': self.code,
        }
...
class FacebookLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        params = {
            ...
            'code': self.code,
            'redirect_uri': 'http://localhost:8888/youtube/api/callback/facebook' if JsonConfig.get_data('APP_MODE') == Config.APP_MODE_DEVELOPMENT else 'http://localhost:8888/youtube/api/callback/facebook',
        }
...
class NaverLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        params = {
            ...
            'code': self.code,
            'state': self.code,
            'redirect_uri': 'http://localhost:8888/youtube/api/callback/naver' if JsonConfig.get_data('APP_MODE') == Config.APP_MODE_DEVELOPMENT else 'http://localhost:8888/youtube/api/callback/naver',
        }
...
class GithubLogin:
    ...
    def get_token(self) -> SnsLoginItem:
        params = {
            ...
            'code': self.code,
            'redirect_uri': 'http://localhost:8888/youtube/api/callback/github' if JsonConfig.get_data('APP_MODE') == Config.APP_MODE_DEVELOPMENT else 'http://localhost:8888/youtube/api/callback/github',
        }
